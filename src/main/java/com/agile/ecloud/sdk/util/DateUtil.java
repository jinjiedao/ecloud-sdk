...
public class DateUtil {
    ...
    private final static SimpleDateFormat sdfDayTime = new SimpleDateFormat("yyyyMMddHHmmss");
    ...
    /**
     * 格式化日期 yyyy-MM-dd HH:mm:ss 日期转换成string yyyy-MM-dd HH:mm:ss
     * 
     * @return
     */
    ...
    public static Date AddMinutes(Date date, Integer minutes) {
        ...
        // //格式化成年月日时分秒
        // System.out.println(df.format(AddMinutes(new Date(),60))); ;
        // //当前日期60分钟以后
        // }
    }
